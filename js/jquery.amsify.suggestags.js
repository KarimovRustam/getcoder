    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        AmsifySuggestags.prototype = {
            ...
            createHTML : function() {
              ...
              var listArea              = '<div id="close" class="'+this.classes.listArea.substring(1)+'"></div>';
            ...
            setDefault : function() {
              ...
              if (settings.keepDefaultLabel || this.tagNames <= 0) {
                $(this.selectors.sTagsInput).attr("placeholder", this.defaultLabel);
              } else {
                $(this.selectors.sTagsInput).removeAttr("placeholder");
              }
            ...
            setInputValue: function() {
              ...
              if (settings.keepDefaultLabel || this.tagNames.length <= 0) {
                $(this.selectors.sTagsInput).attr("placeholder", this.defaultLabel);
              } else {
                $(this.selectors.sTagsInput).removeAttr("placeholder");
              }

              var removeClass = this.classes.readyToRemove.substring(1);
              $(this.selectors.sTagsInput).addClass(removeClass);
